...
GameTree::GameTree(Kinematic *cur, GameWorld *game)
{
    ...
    this->actions.at(1)->goal = new Kinematic(640, 640, -1, "boid.png");
    ...
    this->actions.at(2)->goal = new Kinematic(640, 640, -1, "boid.png");
    ...
    this->actions.at(3)->goal = new Kinematic(640, 640, -1, "boid.png");
    ...
    this->actions.at(4)->goal = new Kinematic(640, 640, -1, "boid.png");
